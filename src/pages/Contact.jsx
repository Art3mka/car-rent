            ...
            <Row>
                ...
                <Col lg='5' md='5'>
                    <div className="contact__info">
                        ...
                        <p className="section__description mb-0">Gomel, Belarus</p>
                        <div className="d-flex align-items-center gap-2">
                            <h6 className='mb-0 fs-6'>Phone:</h6>
                            <p className="section__description mb-0">+375441234567</p>
                        </div>
                        <div className="d-flex align-items-center gap-2">
                            <h6 className='mb-0 fs-6'>Email:</h6>
                            <p className="section__description mb-0">example_email@gmail.com</p>
                        </div>
