            ...
            <div className="comment__list mt-5">
              ...
              <div className="single__comment d-flex gap-3">
                ...
                <div className="comment__content">
                  <h6 className='fw-bold'>Name Surname</h6>
                  <p className="section__description mb-0">Comment Date</p>
                  <p className="section__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam earum iusto tenetur! Officia minima numquam, assumenda aspernatur voluptatum reiciendis voluptas!</p>
